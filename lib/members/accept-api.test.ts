...
let cfg: Cfg = {}
const captured = { member: null as Record<string, unknown> | null, userDeleted: false, inviteUpdate: null as Record<string, unknown> | null }
...
beforeEach(() => { cfg = {}; captured.member = null; captured.userDeleted = false; captured.inviteUpdate = null })
